...
export const environmentLibraryStorePath = path.join(dataDirectory, "qa-environments.json");
export const credentialLibraryStorePath = path.join(dataDirectory, "qa-credentials.json");
